...
export const labs: Lab[] = [
  ...
  },
  {
    ...
    gallery: [
      { src: "/data/Lab/HR-TEM/EDS_Spectrum.jpg", alt: "EDS Spectrum example", caption: "EDS Spectrum" },
      { src: "/data/Lab/HR-TEM/EDS_Mapping.jpg", alt: "EDS Mapping example", caption: "EDS Mapping" },
      { src: "/data/Lab/HR-TEM/EELS-Spectrum.jpg", alt: "EELS Spectrum example", caption: "EELS Spectrum" },
      { src: "/data/Lab/HR-TEM/ZLi.jpg", alt: "Zero Loss Imaging example", caption: "Zero Loss Imaging (ZLi)" },
      { src: "/data/Lab/HR-TEM/EFTEM_Mapping.jpg", alt: "EFTEM Mapping example", caption: "EFTEM Mapping" },
      { src: "/data/Lab/HR-TEM/BFi.jpg", alt: "STEM Imaging example", caption: "BFi" },
      { src: "/data/Lab/HR-TEM/CBED.jpg", alt: "STEM Imaging example", caption: "CBED" },
      { src: "/data/Lab/HR-TEM/DFi.jpg", alt: "STEM Imaging example", caption: "DFi" },
      { src: "/data/Lab/HR-TEM/EFTEM_Mapping.jpg", alt: "STEM Imaging example", caption: "EFTEM Mapping" },
      { src: "/data/Lab/HR-TEM/HRLFi.jpg", alt: "STEM Imaging example", caption: "HRLFi" },
      { src: "/data/Lab/HR-TEM/NBD.jpg", alt: "STEM Imaging example", caption: "NBD" },
      { src: "/data/Lab/HR-TEM/SAED.jpg", alt: "STEM Imaging example", caption: "SAED" },
      { src: "/data/Lab/HR-TEM/STEM-Bfi.jpg", alt: "STEM Imaging example", caption: "STEM Bright-Field Imaging" },
      { src: "/data/Lab/HR-TEM/STEM-HAADFi.jpg", alt: "STEM Imaging example", caption: "STEM High Angle Annular Dark Field Imaging" },
    ],
    equipments: [
